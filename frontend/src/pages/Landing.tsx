...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white relative overflow-hidden flex flex-col">
      ...
      <section style={{ padding: '60px 0', background: 'transparent' }} className="relative z-10">
        <div style={{ maxWidth: '1000px' }} className="mx-auto px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[20px]">
            {/* Stat 1: Active Users */}
            <FadeUp delay={0}>
              <div className="stat-card-custom">
                <div className="stat-accent-line-custom" />
                <div style={{ width: '48px', height: '48px', borderRadius: '14px', background: 'rgba(139,92,246,0.1)', border: '1px solid rgba(139,92,246,0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 20px' }}>
                  <Users size={20} color="#A78BFA" />
                </div>
                <div className="stat-number-custom mb-2">
                  <motion.span
                    key={liveUsers}
                    initial={{ scale: 1.1 }}
                    animate={{ scale: 1 }}
                ...
                <div className="stat-label-custom">Active Users</div>
                <div style={{
            ...
            <FadeUp delay={0.1}>
              <div className="stat-card-custom">
                ...
                <div className="stat-number-custom mb-2">
                  <Counter value="12847" suffix="+" />
                </div>
                <div className="stat-label-custom">Jobs Found This Week</div>
              </div>
            </FadeUp>
            ...
            <FadeUp delay={0.2}>
              <div className="stat-card-custom">
                ...
                <div className="stat-label-custom">Application Success Rate</div>
              </div>
            </FadeUp>
            ...
            <FadeUp delay={0.3}>
              <div className="stat-card-custom">
                ...
                <div className="stat-number-custom mb-2">4.9★</div>
                <div className="stat-label-custom">Average Rating</div>
              </div>
            </FadeUp>
          </div>
        </div>
      ...
      <section className="relative z-10 py-20 px-6 bg-white/[0.01]">
        <div className="max-w-3xl mx-auto">
          ...
          <FadeUp delay={0.4}>
            <div className="cta-card-custom mt-20">
              {/* Floating Orbs */}
              ...
              <div className="relative z-10 flex flex-col items-center">
                {/* Badge */}
                <div className="cta-badge-custom mb-6">
                  ✦ START FOR FREE
                </div>
                
                {/* Heading */}
                <h2 className="cta-heading-custom mb-6">
                  Land your dream job<br />with AI today.
                </h2>
                
                {/* Subtext */}
                <p className="text-white/45 text-base mb-8 max-w-xl mx-auto font-light leading-relaxed">
                  Join thousands of job seekers across India who found better jobs faster with HirenextAI&apos;s AI tools.
                </p>
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4 w-full sm:w-auto">
                  <Link href="/register" className="cta-btn-primary-custom w-full sm:w-auto">
                    Create Free Account <ArrowRight className="ml-2 w-4 h-4" />
                  </Link>
                  <button 
                    onClick={() => setDemoRoleModalOpen(true)} 
                    className="cta-btn-secondary-custom w-full sm:w-auto"
                  >
                    Try Demo First
                  </button>
                </div>
                ...
                {/* Bottom checkmarks */}
                <div className="mt-10 flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-white/30 text-xs font-medium tracking-wide">
                  <div className="flex items-center gap-1.5">
                    <span>✓</span> <span>No Credit Card</span>
                  </div>
                  <div className="flex items-center gap-1.5">
                    <span>✓</span> <span>Setup in 2 min</span>
                  </div>
                  <div className="flex items-center gap-1.5">
      ...
      <style>{`
        ...
        .cta-card-custom {
          background: linear-gradient(135deg, rgba(139,92,246,0.12) 0%, rgba(99,102,241,0.08) 50%, rgba(0,0,0,0) 100%);
